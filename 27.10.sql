...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 27 2022 г., 22:18
...
('99kuu130ma8q5h429jevs7bmadob2pbv', 1, 'admin', 1666898241, '67', 16);
...
('99kuu130ma8q5h429jevs7bmadob2pbv', 1, 1666898241, '127.0.0.1');
...
(2, 'document', 'text/html', 'Блоги', '', '', 'blogs', '', 1, 0, 0, 0, 1, '', '', 1, 3, 1, 1, 1, 1, 1666612248, 1, 1666897172, 0, 0, 0, 1666612248, 1, '', 0, 0, 0, 0, 0, 1),
...
--
ALTER TABLE `i6cn_site_content_closure`
  MODIFY `closure_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
